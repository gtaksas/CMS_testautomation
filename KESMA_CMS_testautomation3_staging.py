...
class VgCms(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.driver.get("http://cmstest.content.private/")
    ...
    def test_openStatistics(self):
        ...
        self.driver.get("http://cmstest.content.private/admin/users-statistics")
